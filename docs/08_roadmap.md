...
Step 14 is completed as the larger-grid validation stage once `STEP14_LARGER_GRID_VALIDATION_REPORT.md` is accepted. The next implementation step is Step 15: moving-boundary reaction calibration and sharper momentum accounting.
