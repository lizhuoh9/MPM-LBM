...
def test_step97_output_guard_passes():
    payload = read_json("outputs/step97_output_guard/output_guard.json")
    ...
    assert summary["step97_raw_geometry_output_count"] == 0
    assert summary["step97_real_geometry_candidate_output_count"] == 0
    assert summary["step97_dense_wall_velocity_output_count"] == 0
    assert summary["step97_sparse_wall_velocity_output_count"] == 0
    assert summary["step97_dense_displacement_output_count"] == 0
    assert summary["step97_displaced_particle_output_count"] == 0
    ...
    assert summary["step97_large_file_count"] == 0
