...
def test_step98_activation_guard_passes():
    payload = read_json("outputs/step98_activation_guard/activation_guard.json")
    ...
    assert summary["required_row_name"] == STEP98_ROW
