...
def test_step86_activation_guard_passes():
    payload = read_json("outputs/step86_activation_guard/activation_guard.json")
    summary = payload["summary"]

    assert summary["step86_activation_guard_pass"] is True
