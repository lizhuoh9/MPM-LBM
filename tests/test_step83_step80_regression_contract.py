...
from src.mpm_lbm.evidence.step83_step80_regression_guard import build_step83_step80_regression_guard


ROOT = Path(__file__).resolve().parents[1]


def test_step83_step80_regression_guard_passes():
    rows, summary = build_step83_step80_regression_guard(ROOT)
    assert rows
...
def test_step83_step80_regression_guard_artifact_passes():
    payload = read_json("outputs/step83_step80_regression_guard/step80_regression_guard.json")
