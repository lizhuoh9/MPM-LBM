...
def test_step97_step96_regression_guard_passes():
    payload = read_json("outputs/step97_step96_regression_guard/step96_regression_guard.json")
    ...
    assert summary["step96_step94_regression_guard_pass"] is True
    ...
    assert summary["step96_ggui_visualization_enabled_count"] == 1
    ...
    assert summary["step96_grid_48_enabled_count"] == 0
    assert summary["step96_grid_64_enabled_count"] == 0
