...
def test_step90_step88_regression_guard_passes():
    payload = read_json("outputs/step90_step88_regression_guard/step88_regression_guard.json")
    summary = payload["summary"]

    assert summary["step90_step88_regression_guard_pass"] is True
