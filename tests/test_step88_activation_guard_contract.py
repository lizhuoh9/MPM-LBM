...
def test_step88_activation_guard_passes():
    payload = read_json("outputs/step88_activation_guard/activation_guard.json")
    summary = payload["summary"]

    assert summary["step88_activation_guard_pass"] is True
