...
def test_step98_step96_regression_guard_passes():
    payload = read_json("outputs/step98_step96_regression_guard/step96_regression_guard.json")
    summary = payload["summary"]

    assert summary["step98_step96_regression_guard_pass"] is True
