...
def test_step98_48cube_taichi_ggui_visualization_quality_passes():
    payload = read_json(
    ...
    assert summary["from_step96_grid_expansion_count"] == 1
    assert summary["from_step96_duration_reduction_count"] == 1
