...
def test_step90_first_user_simulation_dry_run_quality_passes():
    payload = read_json("outputs/step90_first_user_simulation_dry_run_quality/first_user_simulation_dry_run_quality.json")
