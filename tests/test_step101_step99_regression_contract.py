...
def test_step101_step99_regression_guard_passes():
    payload = read_json("outputs/step101_step99_regression_guard/step99_regression_guard.json")
    summary = payload["summary"]

    assert summary["step101_step99_regression_guard_pass"] is True
