...
def test_step87_step84_regression_guard_passes():
    payload = read_json("outputs/step87_step84_regression_guard/step84_regression_guard.json")
    summary = payload["summary"]

    assert summary["step87_step84_regression_guard_pass"] is True
