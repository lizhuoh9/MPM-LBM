...
def test_step102_step100_regression_guard_passes():
    payload = read_json("outputs/step102_step100_regression_guard/step100_regression_guard.json")
    summary = payload["summary"]

    assert summary["step102_step100_regression_guard_pass"] is True
