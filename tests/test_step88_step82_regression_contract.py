...
def test_step88_step82_regression_guard_passes():
    payload = read_json("outputs/step88_step82_regression_guard/step82_regression_guard.json")
    summary = payload["summary"]

    assert summary["step88_step82_regression_guard_pass"] is True
