...
def test_step99_step98_regression_guard_passes():
    payload = read_json("outputs/step99_step98_regression_guard/step98_regression_guard.json")
    ...
    assert summary["step98_step97_regression_guard_pass"] is True
