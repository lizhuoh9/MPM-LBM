...
def test_build_passes():
    ...
    assert summary["changed_schema_classes"] == ["FSIDriverConfig", "GeometryConfig"]
    ...
    unchanged_rows = [row for row in rows if row["class_name"] not in {"FSIDriverConfig", "GeometryConfig"}]
