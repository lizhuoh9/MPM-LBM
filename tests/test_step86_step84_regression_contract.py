...
def test_step86_step84_regression_guard_passes():
    payload = read_json("outputs/step86_step84_regression_guard/step84_regression_guard.json")
    summary = payload["summary"]

    assert summary["step86_step84_regression_guard_pass"] is True
