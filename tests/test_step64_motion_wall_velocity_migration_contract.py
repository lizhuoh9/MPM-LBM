...
def test_artifact_passes():
    payload = read_json("outputs/step64_motion_wall_velocity_migration_audit/audit.json")
    assert payload["summary"]["step64_motion_wall_velocity_migration_pass"] is True
    assert payload["rows"]
