...
def test_step85_step31_reference_guard_passes():
    payload = read_json("outputs/step85_step31_reference_guard/step31_reference_guard.json")
    ...
    assert summary["step30_deterministic"] is True
