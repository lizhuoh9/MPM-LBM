...
def test_step89_step87_regression_guard_passes():
    payload = read_json("outputs/step89_step87_regression_guard/step87_regression_guard.json")
    summary = payload["summary"]

    assert summary["step89_step87_regression_guard_pass"] is True
