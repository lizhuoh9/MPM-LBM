...
def test_step92_first_user_simulation_10step_dry_run_quality_passes():
    payload = read_json("outputs/step92_first_user_simulation_10step_dry_run_quality/first_user_simulation_10step_dry_run_quality.json")
