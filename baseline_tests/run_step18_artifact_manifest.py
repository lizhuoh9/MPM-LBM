...
def main():
    os.chdir(ROOT)
    out_dir = os.path.join(ROOT, "outputs", "step18_artifact_manifest")
    ...
    if summary["large_file_count"] != 0:
        raise RuntimeError("Step 18 artifact manifest found large files")
    ...
    print("Step 18 artifact manifest")
    ...
    print("[OK] Step 18 artifact manifest finished")
