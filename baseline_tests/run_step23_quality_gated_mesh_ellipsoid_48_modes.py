...
def main():
    ...
    out_dir = os.path.join(ROOT, "outputs", "step23_quality_gated_mesh_ellipsoid_48_modes")
    run_quality_gated_config_paths(
        "mesh_ellipsoid",
        CONFIGS,
        out_dir,
        "mesh_ellipsoid_48_quality_gated_results.csv",
        "mesh_ellipsoid_48_quality_gated_results.npz",
    )
    print("[OK] Step 23 quality-gated mesh_ellipsoid 48 modes finished")
