...
def main():
    os.chdir(ROOT)
    out_dir = os.path.join(ROOT, "outputs", "step17_artifact_manifest")
    ...
    if summary["large_file_count"] != 0:
        raise RuntimeError("Step 17 artifact manifest found large files")
    ...
    print("Step 17 artifact manifest")
    ...
    print("[OK] Step 17 artifact manifest finished")
