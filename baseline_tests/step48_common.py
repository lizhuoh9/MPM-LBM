...
STEP48_CONFIG_PATH = "configs/step48_runtime_geometry_wall_velocity_10step_envelope.json"


def load_step48_config():
    from src.runtime_geometry_wall_velocity_10step_config import RuntimeGeometryWallVelocityTenStepEnvelopeConfig

    return RuntimeGeometryWallVelocityTenStepEnvelopeConfig.from_json(resolve_path(STEP48_CONFIG_PATH))


def ten_step_envelope_rows():
    from src.runtime_geometry_wall_velocity_10step_envelope import run_ten_step_envelope_matrix

    return run_ten_step_envelope_matrix(STEP48_CONFIG_PATH)
