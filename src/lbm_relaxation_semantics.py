...
Step 54 does not migrate solver behavior. It names the legacy external solver
parameter separately from standard lattice kinematic viscosity so reports and
tests cannot silently treat the legacy `niu` field as validated physical
viscosity.
"""
