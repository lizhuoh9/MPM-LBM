...
def build_step101_step98_regression_guard(
    root: Path,
    policy_path: str = "configs/step101_step98_regression_policy.json",
    ...
    quality_summary = read_json(
        ...
        / "48cube_taichi_ggui_visualization_quality.json"
    )["summary"]
    ...
    summary = {
        ...
        "row_count": len(rows),
        "step101_step98_regression_guard_pass": False,
    ...
    summary["step101_step98_regression_guard_pass"] = bool(
        rows
