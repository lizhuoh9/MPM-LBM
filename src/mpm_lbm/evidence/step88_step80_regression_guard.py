...
def build_step88_step80_regression_guard(
    root: Path,
    policy_path: str = "configs/step88_step80_regression_policy.json",
    ...
    summary = {
        ...
        "step88_step80_regression_guard_pass": False,
    ...
    summary["step88_step80_regression_guard_pass"] = bool(
        rows
        ...
        and summary["step80_squid_proxy_enabled_count"] == int(policy["expected_squid_proxy_enabled_count"])
