...
def build_step84_runtime_geometry_wall_velocity_combined_quality_audit(
    root: Path,
    matrix_artifact_path: str = "outputs/step84_runtime_geometry_wall_velocity_combined_smoke_matrix/runtime_geometry_wall_velocity_combined_smoke_matrix.json",
    ...
    summary = {
        ...
        "step84_runtime_geometry_wall_velocity_combined_quality_pass": False,
        "wall_velocity_application_report_pass_count": sum(
            1 for row in payload["rows"] if row["wall_velocity_application_report_pass"]
        ),
    }
    summary["step84_runtime_geometry_wall_velocity_combined_quality_pass"] = bool(
        rows
...
def quality_rows(matrix_row: dict, policy: dict) -> list[dict]:
    ...
    rows.extend(
        [
            ...
            bool_row(matrix_row, "previous_step", "Step83"),
            ...
            bool_row(matrix_row, "mutation_flag_enabled_count", 0),
            bool_row(matrix_row, "apply_to_driver", False),
            bool_row(matrix_row, "apply_to_mpm_particles", False),
            bool_row(matrix_row, "apply_to_lbm_solid_phi", False),
            bool_row(matrix_row, "apply_to_lbm_solid_vel", False),
            bool_row(matrix_row, "apply_to_projection", False),
            bool_row(matrix_row, "update_dynamic_solid", False),
            bool_row(matrix_row, "recompute_boundary_links", False),
            bool_row(matrix_row, "mutate_geometry_state", False),
            ...
            bool_row(matrix_row, "apply_to_lbm_solid_vel_wall_velocity", True),
            ...
            bool_row(matrix_row, "combined_runtime_geometry_wall_velocity_enabled", True),
