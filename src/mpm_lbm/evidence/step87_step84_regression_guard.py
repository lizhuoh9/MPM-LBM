...
def build_step87_step84_regression_guard(
    root: Path,
    policy_path: str = "configs/step87_step84_regression_policy.json",
    ...
    summary = {
        ...
        "step87_step84_regression_guard_pass": False,
    }
    summary["step87_step84_regression_guard_pass"] = bool(
        rows
