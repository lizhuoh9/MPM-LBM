...
def build_step88_step84_regression_guard(
    root: Path,
    policy_path: str = "configs/step88_step84_regression_policy.json",
    ...
    summary = {
        ...
        "step88_step84_regression_guard_pass": False,
    ...
    summary["step88_step84_regression_guard_pass"] = bool(
        rows
