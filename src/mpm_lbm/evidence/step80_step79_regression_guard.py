...
def build_step80_step79_regression_guard(
    root: Path,
    policy_path: str = "configs/step80_step79_regression_policy.json",
    ...
    summary = {
        ...
        "row_count": len(rows),
        "step80_step79_regression_guard_pass": False,
    }
    summary["step80_step79_regression_guard_pass"] = bool(
        rows
