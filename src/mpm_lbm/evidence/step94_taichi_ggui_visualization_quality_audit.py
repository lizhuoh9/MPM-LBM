...
def build_step94_taichi_ggui_visualization_quality_audit(
    root: Path,
...
def quality_rows(matrix_row: dict, policy: dict) -> list[dict]:
    ...
    rows.extend(
        [
            ...
            literal_row(matrix_row, "previous_step", "Step93"),
            literal_row(matrix_row, "duration_reduction_for_visualization_isolation", True),
            literal_row(matrix_row, "previous_step92_n_lbm_steps", 10),
            literal_row(matrix_row, "step94_n_lbm_steps", 1),
