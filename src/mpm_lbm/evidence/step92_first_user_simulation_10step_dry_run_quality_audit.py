...
def build_step92_first_user_simulation_10step_dry_run_quality_audit(
    root: Path,
    ...
    summary = {
        ...
        "step92_first_user_simulation_10step_dry_run_quality_pass": False,
        "wall_velocity_application_report_pass_count": sum(
            1 for row in payload["rows"] if row["wall_velocity_application_report_pass"]
        ),
    }
    summary["step92_first_user_simulation_10step_dry_run_quality_pass"] = bool(
        rows
...
def quality_rows(matrix_row: dict, policy: dict) -> list[dict]:
    ...
    rows.extend(
        [
            ...
            literal_row(matrix_row, "previous_step", "Step91"),
            literal_row(matrix_row, "only_duration_expansion_from_step90", True),
            literal_row(matrix_row, "previous_step90_n_lbm_steps", 5),
            literal_row(matrix_row, "step92_n_lbm_steps", 10),
