...
def build_step93_step92_regression_guard(
    root: Path,
    policy_path: str = "configs/step93_step92_regression_policy.json",
    ...
    step91_summary = read_json(root / "outputs/step92_step91_regression_guard/step91_regression_guard.json")[
        "summary"
    ]
    step90_summary = read_json(root / "outputs/step92_step90_regression_guard/step90_regression_guard.json")[
        "summary"
    ]
    step89_summary = read_json(root / "outputs/step92_step89_regression_guard/step89_regression_guard.json")[
        "summary"
    ]
    ...
    summary["step93_step92_regression_guard_pass"] = bool(
        ...
        and summary["step92_step91_regression_guard_pass"] is True
        and summary["step92_step90_regression_guard_pass"] is True
        and summary["step92_step89_regression_guard_pass"] is True
