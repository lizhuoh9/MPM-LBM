...
def build_legacy_shim_audit(
    root: Path,
    policy_path: str = "configs/step56_legacy_shim_policy.json",
    ...
    summary = {
        ...
        "legacy_shim_audit_pass": False,
    }
    summary["legacy_shim_audit_pass"] = bool(summary["row_count"] > 0 and summary["row_count"] == summary["pass_count"])
    return rows, summary
