...
def build_step79_step78_regression_guard(
    root: Path,
    policy_path: str = "configs/step79_step78_regression_policy.json",
    ...
    summary = {
        ...
        "row_count": len(rows),
        "step79_step78_regression_guard_pass": False,
    }
    summary["step79_step78_regression_guard_pass"] = bool(
        rows
