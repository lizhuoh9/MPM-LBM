...
def build_step93_step90_regression_guard(
    root: Path,
    policy_path: str = "configs/step93_step90_regression_policy.json",
    ...
    summary = {
        ...
        "step93_step90_regression_guard_pass": False,
    }
    summary["step93_step90_regression_guard_pass"] = bool(
        rows
