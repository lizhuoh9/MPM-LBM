...
def build_step92_activation_guard(
    root: Path,
    policy_path: str = "configs/step92_activation_guard_policy.json",
    ...
    row = matrix["rows"][0]
    rows = [
        literal_row("matrix_summary", "matrix_pass", summary["step92_first_user_simulation_10step_dry_run_matrix_pass"], True),
    ...
    guard_summary = {
        ...
        "step92_activation_guard_pass": False,
    ...
    guard_summary["step92_activation_guard_pass"] = bool(
        rows
