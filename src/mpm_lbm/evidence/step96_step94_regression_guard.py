...
def build_step96_step94_regression_guard(
    root: Path,
    policy_path: str = "configs/step96_step94_regression_policy.json",
    ...
    summary = {
        ...
        "step94_ggui_visualization_enabled_count": activation_summary["ggui_visualization_enabled_count"],
        ...
        "step96_step94_regression_guard_pass": False,
    }
    summary["step96_step94_regression_guard_pass"] = bool(
        rows
