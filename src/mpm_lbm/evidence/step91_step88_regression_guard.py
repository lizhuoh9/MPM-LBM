...
def build_step91_step88_regression_guard(
    root: Path,
    policy_path: str = "configs/step91_step88_regression_policy.json",
    ...
    summary = {
        ...
        "row_count": len(rows),
        "step88_activation_feature_count": matrix_summary["activation_feature_count"],
        "step88_artifact_budget_pass": artifact_summary["artifact_budget_pass"],
        "step88_combined_runtime_geometry_wall_velocity_enabled_count": matrix_summary[
            "combined_runtime_geometry_wall_velocity_enabled_count"
        ],
        "step88_link_area_enabled_count": matrix_summary["link_area_enabled_count"],
        "step88_particle_npy_count": output_summary["step88_particle_npy_count"],
        "step88_real_geometry_candidate_enabled_count": matrix_summary["real_geometry_candidate_enabled_count"],
        "step88_runtime_geometry_enabled_count": matrix_summary["runtime_geometry_enabled_count"],
        "step88_squid_proxy_enabled_count": matrix_summary["squid_proxy_enabled_count"],
        "step88_vtr_count": output_summary["step88_vtr_count"],
        "step88_wall_velocity_enabled_count": matrix_summary["wall_velocity_enabled_count"],
        "step91_step88_regression_guard_pass": False,
    }
    summary["step91_step88_regression_guard_pass"] = bool(
        rows
        ...
        and summary["step88_squid_proxy_enabled_count"] == 1
        and summary["step88_runtime_geometry_enabled_count"] == 1
        and summary["step88_wall_velocity_enabled_count"] == 1
        and summary["step88_combined_runtime_geometry_wall_velocity_enabled_count"] == 1
