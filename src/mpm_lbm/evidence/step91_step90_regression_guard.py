...
def build_step91_step90_regression_guard(
    root: Path,
    policy_path: str = "configs/step91_step90_regression_policy.json",
    ...
    summary = {
        ...
        "step90_step91_regression_source_commit": "72503260933df8919826ef8fa7ed7cab12b96297",
        ...
        "step91_step90_regression_guard_pass": False,
    }
    summary["step91_step90_regression_guard_pass"] = bool(
        rows
