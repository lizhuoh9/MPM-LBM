...
def build_step94_step93_regression_guard(
    root: Path,
    policy_path: str = "configs/step94_step93_regression_policy.json",
    ...
    summary = {
        ...
        "step94_step93_regression_guard_pass": False,
        "vtr_file_count": output_summary["vtr_file_count"],
    }
    summary["step94_step93_regression_guard_pass"] = bool(
        rows
