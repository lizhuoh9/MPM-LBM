...
def build_step83_step82_regression_guard(
    root: Path,
    policy_path: str = "configs/step83_step82_regression_policy.json",
    ...
    summary = {
        ...
        "step82_link_area_enabled_count": artifact_value(
            root,
            "outputs/step82_wall_velocity_solid_vel_smoke_matrix/wall_velocity_solid_vel_smoke_matrix.json",
        ...
        "step82_real_geometry_enabled_count": artifact_value(
            root,
            "outputs/step82_wall_velocity_solid_vel_smoke_matrix/wall_velocity_solid_vel_smoke_matrix.json",
        ...
        "step82_squid_proxy_enabled_count": artifact_value(
            root,
            "outputs/step82_wall_velocity_solid_vel_smoke_matrix/wall_velocity_solid_vel_smoke_matrix.json",
        ...
        "step83_step82_regression_guard_pass": False,
    }
    summary["step83_step82_regression_guard_pass"] = bool(
        rows
