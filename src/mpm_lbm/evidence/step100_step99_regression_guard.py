...
def build_step100_step99_regression_guard(
    root: Path,
    policy_path: str = "configs/step100_step99_regression_policy.json",
    ...
    summary = {
        ...
        "row_count": len(rows),
        "step100_step99_regression_guard_pass": False,
    ...
    summary["step100_step99_regression_guard_pass"] = bool(
        rows
