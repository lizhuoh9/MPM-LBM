...
def build_step101_step100_regression_guard(
    root: Path,
    policy_path: str = "configs/step101_step100_regression_policy.json",
    ...
    summary = {
        ...
        "step100_activation_feature_count": activation_summary["activation_feature_count"],
        ...
        "step100_ggui_video_count": output_summary["step100_ggui_video_count"],
        "step100_grid_48_enabled_count": matrix_summary["grid_48_enabled_count"],
        "step100_grid_64_enabled_count": matrix_summary["grid_64_enabled_count"],
        ...
        "step100_runtime_geometry_enabled_count": activation_summary["runtime_geometry_enabled_count"],
        "step100_squid_proxy_enabled_count": activation_summary["squid_proxy_enabled_count"],
        "step100_step96_regression_guard_pass": artifact_value(
            root,
            "outputs/step100_step96_regression_guard/step96_regression_guard.json",
            "step100_step96_regression_guard_pass",
        ),
        "step100_step98_regression_guard_pass": artifact_value(
            root,
            "outputs/step100_step98_regression_guard/step98_regression_guard.json",
            "step100_step98_regression_guard_pass",
        ),
        "step100_step99_regression_guard_pass": artifact_value(
            root,
            "outputs/step100_step99_regression_guard/step99_regression_guard.json",
            "step100_step99_regression_guard_pass",
        ),
        "step100_vtr_count": output_summary["step100_vtr_count"],
        "step100_wall_velocity_enabled_count": activation_summary["wall_velocity_enabled_count"],
        "step101_step100_regression_guard_pass": False,
    }
    summary["step101_step100_regression_guard_pass"] = bool(
        rows
        ...
        and summary["step100_step99_regression_guard_pass"] is True
        and summary["step100_step98_regression_guard_pass"] is True
        and summary["step100_step96_regression_guard_pass"] is True
        and summary["step100_artifact_budget_pass"] is True
        and summary["step100_activation_feature_count"] == int(policy["expected_step100_activation_feature_count"])
        ...
        and summary["step100_grid_48_enabled_count"] == int(policy["expected_step100_grid_48_enabled_count"])
        and summary["step100_grid_64_enabled_count"] == int(policy["expected_step100_grid_64_enabled_count"])
        and summary["step100_squid_proxy_enabled_count"] == int(policy["expected_step100_squid_proxy_enabled_count"])
        and summary["step100_runtime_geometry_enabled_count"]
        == int(policy["expected_step100_runtime_geometry_enabled_count"])
        and summary["step100_wall_velocity_enabled_count"] == int(policy["expected_step100_wall_velocity_enabled_count"])
        and summary["step100_ggui_screenshot_count"] == int(policy["expected_step100_ggui_screenshot_count"])
        and summary["step100_ggui_video_count"] == int(policy["expected_step100_ggui_video_count"])
