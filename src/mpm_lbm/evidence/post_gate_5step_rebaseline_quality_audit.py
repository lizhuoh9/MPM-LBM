...
def build_step78_post_gate_5step_rebaseline_quality_audit(
    root: Path,
    ...
    summary = {
        ...
        "post_gate_5step_rebaseline_quality_pass": False,
        "row_count": len(rows),
        "source_matrix_row_count": len(payload["rows"]),
    }
    summary["post_gate_5step_rebaseline_quality_pass"] = bool(
        rows
...
def quality_rows(matrix_row: dict, policy: dict) -> list[dict]:
    ...
    rows.extend(
        [
            ...
            bool_row(matrix_row, "previous_rebaseline_step", "Step77"),
            {
