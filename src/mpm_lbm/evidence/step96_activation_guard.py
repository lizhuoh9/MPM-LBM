...
def build_step96_activation_guard(
    root: Path,
    policy_path: str = "configs/step96_activation_guard_policy.json",
    ...
    row = matrix["rows"][0]
    rows = [
        literal_row("matrix_summary", "matrix_pass", summary["step96_taichi_ggui_10step_visualization_run_matrix_pass"], True),
    ...
    guard_summary = {
        ...
        "step96_activation_guard_pass": False,
    ...
    guard_summary["step96_activation_guard_pass"] = bool(
        rows
