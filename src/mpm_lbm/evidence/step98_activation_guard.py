...
def build_step98_activation_guard(
    root: Path,
    policy_path: str = "configs/step98_activation_guard_policy.json",
    ...
    rows = [
        literal_row(
            "matrix_summary",
            "matrix_pass",
            summary["step98_48cube_taichi_ggui_visualization_smoke_matrix_pass"],
            True,
        ),
        literal_row(
            "matrix_summary",
    ...
    guard_summary = {
        ...
        "step98_activation_guard_pass": False,
    ...
    guard_summary["step98_activation_guard_pass"] = bool(
        rows
