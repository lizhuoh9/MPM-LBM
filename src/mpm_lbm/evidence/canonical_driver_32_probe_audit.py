...
from .canonical_driver_32_probe_runner import probe_32_row_pass


def build_canonical_driver_32_probe_audit(
    root: Path,
    matrix_artifact_path: str = "outputs/step61_32_probe_matrix/probe_32_matrix.json",
    ...
    summary = {
        ...
        "probe_32_audit_pass": False,
    }
    summary["probe_32_audit_pass"] = bool(
...
def audit_row(row: dict, policy: dict) -> dict:
    passed = bool(row["stable"] and probe_32_row_pass(row, policy))
    return {
