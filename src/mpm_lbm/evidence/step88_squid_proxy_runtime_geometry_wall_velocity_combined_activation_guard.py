...
def build_step88_squid_proxy_runtime_geometry_wall_velocity_combined_activation_guard(
    root: Path,
    policy_path: str = "configs/step88_activation_guard_policy.json",
    ...
    row = matrix["rows"][0]
    rows = [
        literal_row("matrix_summary", "smoke_matrix_pass", summary["step88_squid_proxy_runtime_geometry_wall_velocity_combined_smoke_matrix_pass"], True),
    ...
    guard_summary = {
        ...
        "step88_activation_guard_pass": False,
    ...
    guard_summary["step88_activation_guard_pass"] = bool(
        rows
