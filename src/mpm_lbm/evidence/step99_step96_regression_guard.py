...
def build_step99_step96_regression_guard(
    root: Path,
    policy_path: str = "configs/step99_step96_regression_policy.json",
    ...
    summary = {
        ...
        "step99_step96_regression_guard_pass": False,
    }
    summary["step99_step96_regression_guard_pass"] = bool(
        rows
