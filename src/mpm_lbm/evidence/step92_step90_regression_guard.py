...
def build_step92_step90_regression_guard(
    root: Path,
    policy_path: str = "configs/step92_step90_regression_policy.json",
    ...
    summary = {
        ...
        "step90_accepted_source_commit": "72503260933df8919826ef8fa7ed7cab12b96297",
        ...
        "step92_step90_regression_guard_pass": False,
    }
    summary["step92_step90_regression_guard_pass"] = bool(
        rows
