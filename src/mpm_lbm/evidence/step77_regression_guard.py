...
def build_step77_step76_regression_guard(
    root: Path,
    policy_path: str = "configs/step77_step76_regression_policy.json",
    ...
    summary = {
        ...
        "row_count": len(rows),
        "step77_step76_regression_guard_pass": False,
    }
    summary["step77_step76_regression_guard_pass"] = bool(
        rows
