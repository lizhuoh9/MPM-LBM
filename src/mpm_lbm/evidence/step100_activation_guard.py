...
def build_step100_activation_guard(
    root: Path,
    policy_path: str = "configs/step100_activation_guard_policy.json",
    ...
    rows = [
        literal_row(
            "matrix_summary",
            "matrix_pass",
            summary["step100_48cube_5step_taichi_ggui_visualization_run_matrix_pass"],
            True,
        ),
        literal_row(
            "matrix_summary",
            "activation_feature_count",
            summary["activation_feature_count"],
            policy["expected_activation_feature_count"],
        ),
        literal_row(
            "matrix_summary",
            "squid_proxy_enabled_count",
            summary["squid_proxy_enabled_count"],
            policy["expected_squid_proxy_enabled_count"],
        ),
        literal_row(
            "matrix_summary",
            "runtime_geometry_enabled_count",
            summary["runtime_geometry_enabled_count"],
            policy["expected_runtime_geometry_enabled_count"],
        ),
        literal_row(
            "matrix_summary",
            "wall_velocity_enabled_count",
            summary["wall_velocity_enabled_count"],
            policy["expected_wall_velocity_enabled_count"],
        ),
        literal_row(
            "matrix_summary",
            "combined_runtime_geometry_wall_velocity_enabled_count",
            summary["combined_runtime_geometry_wall_velocity_enabled_count"],
            policy["expected_combined_runtime_geometry_wall_velocity_enabled_count"],
        ),
        literal_row(
            "matrix_summary",
            "ggui_visualization_enabled_count",
            summary["ggui_visualization_enabled_count"],
            policy["expected_ggui_visualization_enabled_count"],
        ),
        literal_row(
            "matrix_summary",
            "grid_48_enabled_count",
            summary["grid_48_enabled_count"],
            policy["expected_grid_48_enabled_count"],
        ),
        literal_row(
            "matrix_summary",
            "grid_64_enabled_count",
            summary["grid_64_enabled_count"],
            policy["expected_grid_64_enabled_count"],
        ),
        literal_row(
            "matrix_summary",
            "ggui_renderer_called_count",
            summary["ggui_renderer_called_count"],
            policy["expected_ggui_renderer_called_count"],
        ),
        literal_row(
            "matrix_summary",
            "ggui_screenshot_count",
            summary["ggui_screenshot_count"],
            policy["expected_ggui_screenshot_count"],
        ),
        ...
        literal_row(
            ...
            row["geometry_config_path"],
            policy["expected_geometry_config_path"],
        ),
        literal_row(
            "matrix_row",
    ...
    guard_summary = {
        ...
        "step100_activation_guard_pass": False,
    ...
    guard_summary["step100_activation_guard_pass"] = bool(
        rows
        ...
        and guard_summary["grid_64_enabled_count"] == int(policy["expected_grid_64_enabled_count"])
