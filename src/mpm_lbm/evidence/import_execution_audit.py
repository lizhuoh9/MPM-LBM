...
def build_import_execution_audit(
    root: Path,
    policy_path: str = "configs/step56_import_execution_policy.json",
    ...
    summary = {
        ...
        "import_execution_audit_pass": False,
    }
    summary["import_execution_audit_pass"] = bool(
        summary["row_count"] > 0
