...
def build_step92_first_user_simulation_10step_dry_run_audit(
    root: Path,
        ...
        rows.extend(
            [
                ...
                literal_row(
                    ...
                    row["only_duration_expansion_from_step90"],
                    True,
                ),
                literal_row(row["row_name"], "previous_step90_n_lbm_steps", row["previous_step90_n_lbm_steps"], 5),
                literal_row(row["row_name"], "step92_n_lbm_steps", row["step92_n_lbm_steps"], 10),
    ...
    summary = {
        ...
        "row_count": len(rows),
        "step92_first_user_simulation_10step_dry_run_audit_pass": False,
    }
    summary["step92_first_user_simulation_10step_dry_run_audit_pass"] = bool(
        rows
        and summary["pass_count"] == summary["row_count"]
        and payload["summary"]["step92_first_user_simulation_10step_dry_run_matrix_pass"] is True
    )
    return rows, summary
