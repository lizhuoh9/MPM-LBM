...
def build_step98_step97_regression_guard(
    root: Path,
    policy_path: str = "configs/step98_step97_regression_policy.json",
    ...
    summary = {
        ...
        "step98_step97_regression_guard_pass": False,
    }
    summary["step98_step97_regression_guard_pass"] = bool(
        rows
