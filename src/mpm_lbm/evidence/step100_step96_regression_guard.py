...
def build_step100_step96_regression_guard(
    root: Path,
    policy_path: str = "configs/step100_step96_regression_policy.json",
    ...
    summary = {
        ...
        "step96_n_grid": matrix_row["n_grid"],
        ...
        "step100_step96_regression_guard_pass": False,
    }
    summary["step100_step96_regression_guard_pass"] = bool(
        rows
        ...
        and summary["step96_n_grid"] == int(policy["expected_step96_n_grid"])
