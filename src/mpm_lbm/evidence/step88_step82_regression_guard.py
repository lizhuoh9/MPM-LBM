...
def build_step88_step82_regression_guard(
    root: Path,
    policy_path: str = "configs/step88_step82_regression_policy.json",
    ...
    summary = {
        ...
        "step88_step82_regression_guard_pass": False,
    ...
    summary["step88_step82_regression_guard_pass"] = bool(
        rows
        ...
        and summary["step82_squid_proxy_enabled_count"] == int(policy["expected_squid_proxy_enabled_count"])
