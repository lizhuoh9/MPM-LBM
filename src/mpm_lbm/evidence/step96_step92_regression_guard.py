...
def build_step96_step92_regression_guard(
    root: Path,
    policy_path: str = "configs/step96_step92_regression_policy.json",
    ...
    summary = {
        ...
        "step96_step92_regression_guard_pass": False,
        "vtr_file_count": output_summary["step92_vtr_count"],
    }
    summary["step96_step92_regression_guard_pass"] = bool(
        rows
