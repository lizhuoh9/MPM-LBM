...
def build_step97_step94_regression_guard(
    root: Path,
    policy_path: str = "configs/step97_step94_regression_policy.json",
    ...
    summary = {
        ...
        "step97_step94_regression_guard_pass": False,
    }
    summary["step97_step94_regression_guard_pass"] = bool(
        rows
