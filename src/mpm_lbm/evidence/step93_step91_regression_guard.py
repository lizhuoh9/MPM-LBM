...
def build_step93_step91_regression_guard(
    root: Path,
    policy_path: str = "configs/step93_step91_regression_policy.json",
    ...
    step90_summary = read_json(root / "outputs/step91_step90_regression_guard/step90_regression_guard.json")[
        "summary"
    ]
    step89_summary = read_json(root / "outputs/step91_step89_regression_guard/step89_regression_guard.json")[
        "summary"
    ]
    step88_summary = read_json(root / "outputs/step91_step88_regression_guard/step88_regression_guard.json")[
        "summary"
    ]
    ...
    summary = {
        ...
        "step91_step88_regression_guard_pass": step88_summary["step91_step88_regression_guard_pass"],
        "step91_step89_regression_guard_pass": step89_summary["step91_step89_regression_guard_pass"],
        "step91_step90_regression_guard_pass": step90_summary["step91_step90_regression_guard_pass"],
        ...
        "step93_step91_regression_guard_pass": False,
    }
    summary["step93_step91_regression_guard_pass"] = bool(
        rows
        and summary["artifact_pass_count"] == summary["artifact_check_count"]
        and summary["step91_first_user_simulation_10step_dry_run_plan_pass"] is True
        and summary["step91_first_user_simulation_10step_dry_run_guard_pass"] is True
        and summary["step91_step90_regression_guard_pass"] is True
        and summary["step91_step89_regression_guard_pass"] is True
        and summary["step91_step88_regression_guard_pass"] is True
        and summary["step91_output_guard_pass"] is True
