...
EXPECTED_PLAN_VALUES = {
    ...
    "geometry_type_allowed_for_step92": "squid_proxy",
    "geometry_config_path_allowed_for_step92": "configs/step85_squid_proxy_geometry_1024.json",
    "quality_check_enabled_allowed_for_step92": True,
    "quality_check_strict_allowed_for_step92": False,
    "geometry_quality_report_required_for_step92": True,
    "runtime_geometry_planned_for_step92": True,
    "geometry_motion_mode_allowed_for_step92": "prescribed_kinematic",
    "geometry_motion_application_mode_allowed_for_step92": "diagnostic_only",
    "geometry_motion_config_path_allowed_for_step92": "configs/step80_geometry_motion_interface_prescribed_diagnostic_only.json",
    "geometry_motion_application_config_path_allowed_for_step92": "configs/step80_geometry_motion_interface_prescribed_diagnostic_only.json",
    "geometry_motion_interface_report_required_for_step92": True,
    "geometry_motion_application_report_required_for_step92": True,
    "geometry_mutation_allowed": False,
    "wall_velocity_planned_for_step92": True,
    "boundary_motion_mode_allowed_for_step92": "prescribed_kinematic",
    "boundary_motion_config_path_allowed_for_step92": "configs/step34_boundary_motion_interface_prescribed_kinematic.json",
    "boundary_motion_report_required_for_step92": True,
    "wall_velocity_application_mode_allowed_for_step92": "solid_vel_experimental",
    "wall_velocity_application_config_path_allowed_for_step92": "configs/step36_wall_velocity_application_solid_vel_experimental.json",
    "wall_velocity_application_report_required_for_step92": True,
...
def build_step91_first_user_simulation_10step_dry_run_plan(
    root: Path,
    plan_path: str = "configs/step91_first_user_simulation_10step_dry_run_plan.json",
    ...
    summary.update(
        {
            ...
            "row_count": len(rows),
            "step91_first_user_simulation_10step_dry_run_plan_pass": False,
        }
    )
    summary["step91_first_user_simulation_10step_dry_run_plan_pass"] = bool(
        rows
        ...
        and summary["step92_allowed"] is True
        and summary["step92_allowed_n_grid"] == 32
        and summary["step92_allowed_n_particles"] == 1024
        and summary["step92_allowed_n_lbm_steps"] == 10
        and summary["only_duration_expansion_from_step90"] is True
        and summary["previous_step90_n_lbm_steps"] == 5
        and summary["planned_step92_n_lbm_steps"] == 10
        and summary["step91_activation_feature_count"] == 0
        and summary["planned_step92_activation_feature_count"] == 3
        ...
        and summary["target_u_lbm_allowed_for_step92"] == [0.0, 0.0, 0.0]
...
def plan_row(plan: dict, key: str, expected) -> dict:
    ...
    return {
        ...
        "row_name": plan.get("step92_allowed_row_name", ""),
    }
