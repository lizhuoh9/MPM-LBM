...
def build_step72_runtime_geometry_driver_gate_audit(
    root: Path,
    policy_path: str = "configs/step72_runtime_geometry_driver_gate_policy.json",
    ...
    summary = {
        ...
        "driver_run": False,
        "runtime_geometry_driver_gate_audit_pass": False,
    }
    summary["runtime_geometry_driver_gate_audit_pass"] = bool(
        rows
