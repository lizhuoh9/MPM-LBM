...
def build_step90_activation_guard(
    root: Path,
    policy_path: str = "configs/step90_activation_guard_policy.json",
    ...
    row = matrix["rows"][0]
    rows = [
        literal_row("matrix_summary", "matrix_pass", summary["step90_first_user_simulation_dry_run_matrix_pass"], True),
    ...
    guard_summary = {
        ...
        "step90_activation_guard_pass": False,
    ...
    guard_summary["step90_activation_guard_pass"] = bool(
        rows
