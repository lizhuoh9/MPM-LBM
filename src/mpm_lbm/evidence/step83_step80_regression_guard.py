...
def build_step83_step80_regression_guard(
    root: Path,
    policy_path: str = "configs/step83_step80_regression_policy.json",
    ...
    summary = {
        ...
        "step83_step80_regression_guard_pass": False,
    }
    summary["step83_step80_regression_guard_pass"] = bool(
        rows
