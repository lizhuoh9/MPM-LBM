...
def build_step93_taichi_ggui_visualization_enablement_guard(
    root: Path,
    policy_path: str = "configs/step93_taichi_ggui_visualization_enablement_guard_policy.json",
    ...
    for flag in policy["plan_summary_flags_must_be_false"]:
        rows.append(literal_row("step94_ggui_visual_smoke_plan", flag, bool(plan_summary[flag]), False))
    ...
    summary = {
        ...
        "duration_reduction_for_visualization_isolation": plan_summary[
            "duration_reduction_for_visualization_isolation"
        ],
        ...
        "ggui_interactive_window_allowed_for_step94": plan_summary["ggui_interactive_window_allowed_for_step94"],
        "ggui_screenshot_allowed_for_step94": plan_summary["ggui_screenshot_allowed_for_step94"],
        "ggui_video_allowed_for_step94": plan_summary["ggui_video_allowed_for_step94"],
        "ggui_visualization_planned_for_step94": plan_summary["ggui_visualization_planned_for_step94"],
        "ggui_visualization_smoke_isolation": plan_summary["ggui_visualization_smoke_isolation"],
        ...
        "particle_npy_output_planned_for_step94": plan_summary["particle_npy_output_allowed"],
        ...
        "step93_taichi_ggui_visualization_enablement_guard_pass": False,
        ...
        "vtr_route_allowed_for_step94": plan_summary["vtr_output_allowed"],
        ...
        "write_particles_allowed_for_step94": plan_summary["write_particles_allowed"],
        "write_vtk_planned_for_step94": plan_summary["write_vtk_allowed"],
    }
    summary["step93_taichi_ggui_visualization_enablement_guard_pass"] = bool(
        rows
        ...
        and summary["write_vtk_planned_for_step94"] is False
        and summary["write_particles_allowed_for_step94"] is False
        and summary["vtr_route_allowed_for_step94"] is False
        and summary["particle_npy_output_planned_for_step94"] is False
...
def summary_checks(summary: dict, policy: dict) -> list[dict]:
    ...
    return [literal_row("step94_ggui_visual_smoke_plan", check, summary[check], expected) for check, expected in checks]
