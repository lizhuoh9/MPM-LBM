...
def build_step73_wall_velocity_api_audit(
    root: Path,
    policy_path: str = "configs/step73_wall_velocity_api_policy.json",
    ...
    summary = {
        ...
        "solver_run": False,
        "wall_velocity_api_audit_pass": False,
    }
    summary["wall_velocity_api_audit_pass"] = bool(
