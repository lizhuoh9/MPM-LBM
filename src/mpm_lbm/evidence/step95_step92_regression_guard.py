...
def build_step95_step92_regression_guard(
    root: Path,
    policy_path: str = "configs/step95_step92_regression_policy.json",
    ...
    summary = {
        ...
        "step95_step92_regression_guard_pass": False,
        "vtr_file_count": output_summary["step92_vtr_count"],
    }
    summary["step95_step92_regression_guard_pass"] = bool(
        rows
