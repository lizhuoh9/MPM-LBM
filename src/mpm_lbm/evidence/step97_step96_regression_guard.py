...
def build_step97_step96_regression_guard(
    root: Path,
    policy_path: str = "configs/step97_step96_regression_policy.json",
    ...
    summary = {
        ...
        "step96_ggui_visualization_enabled_count": activation_summary["ggui_visualization_enabled_count"],
        ...
        "step97_step96_regression_guard_pass": False,
    }
    summary["step97_step96_regression_guard_pass"] = bool(
        rows
        ...
        and summary["step96_step95_regression_guard_pass"] is True
        and summary["step96_step94_regression_guard_pass"] is True
        and summary["step96_step92_regression_guard_pass"] is True
        ...
        and summary["step96_ggui_visualization_enabled_count"]
        == int(policy["expected_step96_ggui_visualization_enabled_count"])
