...
def build_step103_step100_regression_guard(
    root: Path,
    policy_path: str = "configs/step103_step100_regression_policy.json",
    ...
    matrix = read_json(
        root
        / "outputs/step100_48cube_5step_taichi_ggui_visualization_run_matrix/48cube_5step_taichi_ggui_visualization_run_matrix.json"
    )["summary"]
    activation = read_json(root / "outputs/step100_activation_guard/activation_guard.json")["summary"]
    ...
    summary = {
        ...
        "row_count": len(rows),
        "step100_48cube_5step_taichi_ggui_visualization_run_matrix_pass": matrix[
            "step100_48cube_5step_taichi_ggui_visualization_run_matrix_pass"
        ],
        "step100_activation_guard_pass": activation["step100_activation_guard_pass"],
        "step100_artifact_budget_pass": artifact_summary["artifact_budget_pass"],
        "step100_completed_lbm_steps": matrix["min_completed_lbm_steps"],
        "step100_ggui_screenshot_count": output_summary["step100_ggui_screenshot_count"],
        "step100_grid_48_enabled_count": matrix["grid_48_enabled_count"],
        ...
        "step103_step100_regression_guard_pass": False,
    }
    summary["step103_step100_regression_guard_pass"] = bool(
        rows
