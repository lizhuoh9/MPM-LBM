...
def build_step89_step87_regression_guard(
    root: Path,
    policy_path: str = "configs/step89_step87_regression_policy.json",
    ...
    artifact_summary = read_json(root / "outputs/step87_artifact_manifest/artifact_summary.json")
    summary = {
        ...
        "step87_artifact_budget_pass": artifact_summary["artifact_budget_pass"],
        ...
        "step89_step87_regression_guard_pass": False,
    }
    summary["step89_step87_regression_guard_pass"] = bool(
        rows
        and summary["artifact_pass_count"] == summary["artifact_check_count"]
        and summary["step87_artifact_budget_pass"] is True
        ...
        and summary["step87_driver_run_dir_count"] == int(policy["expected_step87_driver_run_dir_count"])
        and summary["step87_vtr_count"] == int(policy["expected_step87_vtr_count"])
        and summary["step87_particle_npy_count"] == int(policy["expected_step87_particle_npy_count"])
    )
    return rows, summary
