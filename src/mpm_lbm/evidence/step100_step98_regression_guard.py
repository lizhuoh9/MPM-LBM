...
def build_step100_step98_regression_guard(
    root: Path,
    policy_path: str = "configs/step100_step98_regression_policy.json",
    ...
    summary = {
        ...
        "step100_step98_regression_guard_pass": False,
    }
    summary["step100_step98_regression_guard_pass"] = bool(
        rows
